...
<div class="wrapper">
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color: rgb(154, 205, 49);">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <font color='white'> <?= session()->get('nama_admin'); ?> &nbsp;&nbsp;&nbsp;<font color='white'><i class="far fa-user"></font></i>&nbsp;&nbsp;&nbsp;<i class="fas fa-angle-left"></i></font>
        </a>
